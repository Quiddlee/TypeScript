...
// interface ElevatedEmmployee extends Admin, Employee {}; 

type ElevatedEmmployee = Admin & Employee;

const e1: ElevatedEmmployee = {
    name: 'Bogdan',
...
// printEmployeeInformation({name: 'check',  startDate: new Date()});
...
// interface ErroConteiner {
//     [prop: string]: string | null;
// }

// const erroBag: ErroConteiner = {
